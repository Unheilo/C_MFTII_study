...
(малые буквы).
Файлы содержат текст на русском языке в кодировке cp1251 (Win1251) и
находятся в каталоге "тексты".
...
приведена также таблица кодировки cp1251, 
обратите внимание на положение буквы ё.
